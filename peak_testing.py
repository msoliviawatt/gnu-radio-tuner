...
import peak_testing_epy_block_0 as epy_block_0  # embedded python block
import sip



class peak_testing(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "peak_testing")
        ...
        self.fft_vxx_0 = fft.fft_vfc(fft_size, True, window.blackmanharris(1024), False, 1)
        self.epy_block_0 = epy_block_0.blk(samp_rate=samp_rate, fft_size=1024)
...
def main(top_block_cls=peak_testing, options=None):
