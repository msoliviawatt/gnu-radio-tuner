...
class a440(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "a440")
        ...
        self.note_freq = note_freq = 440

        ##################################################
        # Blocks
        ##################################################

        self._note_freq_range = qtgui.Range(0, 8000, 10, 440, 200)
...
def main(top_block_cls=a440, options=None):
