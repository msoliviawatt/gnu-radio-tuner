...
class violin_resynth(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        if len('C:\\Users\\OWATT\\Documents\\Random\\Tuner_Project\\elmer_conducting.png') > 0:
            bkgnd="background-image: url(" + 'C:\\Users\\OWATT\\Documents\\Random\\Tuner_Project\\elmer_conducting.png' + "); background-repeat: repeat_n; background-position: " + "center" + ";"
        else:
            bkgnd = ''
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, note_freq, 1, 0, 0)
    ...
    def set_note_freq(self, note_freq):
        ...
        self.analog_sig_source_x_0_0.set_frequency(self.note_freq)
