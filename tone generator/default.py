...
class default(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Music Tone Generator", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Music Tone Generator")
        ...
        self.top_layout.addWidget(self._octave_group_box)
        # Create the options list
